#!/bin/bash
#Generated on 2022-04-13 18:26:11 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=dbf7ed68-68a6-49e6-b6ec-4d9e69e9517d&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
